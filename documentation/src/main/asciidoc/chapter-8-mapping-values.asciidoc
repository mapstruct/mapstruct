...
.Custom enumeration mapping annotations
====
[source, java, linenums]
[subs="verbatim,attributes"]
----
...
----
====
It can be used to describe some common enumeration mapping relationships to avoid duplicate declarations, as in the following example:
