...
[WARNING]
====
Using direct field mappings is considered experimental as of the 1.2.0.CR1 release. If you have any issues with the
generated code please raise an issue in our https://github.com/mapstruct/mapstruct/issues[issue tracker].
====
