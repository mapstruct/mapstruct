...
.Generated mapper for mappings with direct field access
====
[source, java, linenums]
[subs="verbatim,attributes"]
----
...
public class CustomerMapperImpl implements CustomerMapper {
    ...
    public Customer toCustomer(CustomerDto customerDto) {
        ...
        Collection<OrderItem> collection = orderItemDtoListToOrderItemCollection( customerDto.orders );
        if ( collection != null ) {
    ...
    protected Collection<OrderItem> orderItemDtoListToOrderItemCollection(List<OrderItemDto> list) {
        //MapStruct default implementation
    }
