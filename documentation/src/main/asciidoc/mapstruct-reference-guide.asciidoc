    ...
    <plugins>
        <plugin>
            ...
            <configuration>
                ...
                <!-- for enabling verbose mode, uncommment: showWarnings>true</showWarnings -->
            </configuration>
        </plugin>
    </plugins>
</build>
...
----
====
To enable verbose mode, in which MapStruct logs its major decisions, add `showWarnings` to the maven configuration.
