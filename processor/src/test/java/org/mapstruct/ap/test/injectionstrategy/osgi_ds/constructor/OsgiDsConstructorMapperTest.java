...
/**
 * Test constructor injection for component model osgi-ds.
 *
 */
@WithClasses( {
    ...
    Gender.class,
    GenderDto.class,
    CustomerRecordOsgiDsConstructorMapper.class,
    CustomerOsgiDsConstructorMapper.class,
    GenderOsgiDsConstructorMapper.class,
    ConstructorOsgiDsConfig.class
} )
@IssueKey("2400")
@RunWith(AnnotationProcessorTestRunner.class)
@Component
public class OsgiDsConstructorMapperTest {
    ...
    @Reference
    private CustomerRecordOsgiDsConstructorMapper customerRecordMapper;
    ...
    public void shouldHaveConstructorInjection() {
        generatedSource.forMapper( CustomerOsgiDsConstructorMapper.class )
            .content()
            .contains( "private final GenderOsgiDsConstructorMapper" )
            .contains( "@Component" + lineSeparator() +
                "public class CustomerOsgiDsConstructorMapperImpl" )
            .contains( "@Activate" + lineSeparator() +
                "    public CustomerOsgiDsConstructorMapperImpl(@Reference GenderOsgiDsConstructorMapper" );
    }
