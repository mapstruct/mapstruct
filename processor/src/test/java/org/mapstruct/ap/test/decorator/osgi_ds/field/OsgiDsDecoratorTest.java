...
public class OsgiDsDecoratorTest {
    ...
    @Test
    public void shouldExtendDecoratorAndHaveFieldInjection() {
        generatedSource.forMapper( org.mapstruct.ap.test.decorator.osgi_ds.field.PersonMapper.class )
                .content()
                .contains( "@Reference" + lineSeparator() + "    private PersonMapper" )
                .contains( "@Component" + lineSeparator() +
                        "public class PersonMapperImpl extends PersonMapperDecorator" )
                .doesNotContain( "public PersonMapperImpl(" );
    }
}
