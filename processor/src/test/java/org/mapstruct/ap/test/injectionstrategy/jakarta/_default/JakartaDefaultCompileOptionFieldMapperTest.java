...
@ComponentScan(basePackageClasses = CustomerJakartaDefaultCompileOptionFieldMapper.class)
@WithJakartaInject
@Configuration
public class JakartaDefaultCompileOptionFieldMapperTest {
    ...
    @Inject
    @Named
    private CustomerJakartaDefaultCompileOptionFieldMapper customerMapper;
