 ...
 */
@Mapper
public abstract class ArtistToChartEntryUpdateReverse {

    public static final ArtistToChartEntryUpdateReverse MAPPER =
        Mappers.getMapper( ArtistToChartEntryUpdateReverse.class );
    ...
    abstract void mapReverse(ChartEntry ce, @MappingTarget Song song);
