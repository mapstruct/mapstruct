...
public interface SourceTargetPresenceCheckMapper {

    SourceTargetPresenceCheckMapper INSTANCE = Mappers.getMapper( SourceTargetPresenceCheckMapper.class );
    ...
    /*
     * Seeing exception since there is no presence check method on source
     *
    @Mappings( {
        @Mapping(target = "someDouble", defaultValue = "111.1"),
        @Mapping(target = "someInteger", defaultValue = "222"),
