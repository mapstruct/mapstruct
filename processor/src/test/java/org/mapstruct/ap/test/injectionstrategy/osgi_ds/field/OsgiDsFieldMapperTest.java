...
@WithClasses({
    ...
    Gender.class,
    GenderDto.class,
    CustomerOsgiDsFieldMapper.class,
    GenderOsgiDsFieldMapper.class,
    FieldOsgiDsConfig.class
})
@IssueKey("2400")
@RunWith(AnnotationProcessorTestRunner.class)
@Component
public class OsgiDsFieldMapperTest {

    @Rule
    public final GeneratedSource generatedSource = new GeneratedSource();

    @Reference
    private CustomerOsgiDsFieldMapper customerMapper;
    ...
    public void shouldHaveFieldInjection() {
        generatedSource.forMapper( CustomerOsgiDsFieldMapper.class )
            .content()
            .contains( "@Reference" + lineSeparator() + "    private GenderOsgiDsFieldMapper" )
            .doesNotContain( "public CustomerOsgiDsFieldMapperImpl(" );
    }
}
