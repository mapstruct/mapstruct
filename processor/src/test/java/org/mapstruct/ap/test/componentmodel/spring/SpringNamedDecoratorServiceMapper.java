...
public interface SpringNamedDecoratorServiceMapper {
    SpringNamedDecoratorServiceMapper INSTANCE = Mappers.getMapper( SpringNamedDecoratorServiceMapper.class );

    String stringToString(String value);

    abstract class SpringNamedDecoratorServiceMapperDecorator implements SpringNamedDecoratorServiceMapper {
        @Autowired
        @Qualifier("delegate")
        private SpringNamedDecoratorServiceMapper delegate;
