...
public class GenericsHierarchyTest {
    ...
    public void determinesAnimalKeyGetter() {
        ...
        assertThat( target.getItemC().typeParameterIsResolvedToAnimalKey() ).isTrue();
        assertThat( target.getItemC().typeParameterIsResolvedToKeyOfAllBeings() ).isFalse();
    }
    ...
    public void determinesKeyOfAllBeingsGetter() {
        ...
        assertThat( target.getItemB().typeParameterIsResolvedToKeyOfAllBeings() ).isTrue();
    }
    ...
    public void determinesItemBSourceSetter() {
        ...
        target.setItemB( new KeyOfAllBeings() );
