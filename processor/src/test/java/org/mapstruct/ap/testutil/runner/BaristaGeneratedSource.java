 ...
 */
public class BaristaGeneratedSource implements BeforeTestExecutionCallback, AfterTestExecutionCallback {
     ...
     */
    public BaristaGeneratedSource addComparisonToFixtureFor(Class<?>... fixturesFor) {
