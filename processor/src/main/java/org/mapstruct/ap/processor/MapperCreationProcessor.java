...
import org.mapstruct.ap.processor.creation.BeanMappingBuilder;
import org.mapstruct.ap.processor.creation.EnumMappingBuilder;
import org.mapstruct.ap.processor.creation.IterableMappingBuilder;
import org.mapstruct.ap.processor.creation.MapMappingBuilder;
import org.mapstruct.ap.processor.creation.MappingContext;
...
public class MapperCreationProcessor implements ModelElementProcessor<List<SourceMethod>, Mapper> {
    ...
    public Mapper process(ProcessorContext context, TypeElement mapperTypeElement, List<SourceMethod> sourceModel) {
        ...
        this.mappingContext =  new MappingContext(typeFactory, elementUtils, typeUtils, messager, options,
                mapperTypeElement, sourceModel );
    ...
    private List<MappingMethod> getMappingMethods(List<SourceMethod> methods ) {
        ...
        for ( SourceMethod method : methods ) {
            ...
            if ( method.isIterableMapping() ) {
                IterableMappingBuilder builder = new IterableMappingBuilder( mappingContext );
                ...
                IterableMappingMethod iterableMappingMethod = builder.build( method, dateFormat, qualifiers );
                ...
                MapMappingBuilder builder = new MapMappingBuilder( mappingContext );
                ...
                MapMappingMethod mapMappingMethod = builder.build(
                        method,
                        keyDateFormat,
                        valueDateFormat,
                        keyQualifiers,
                ...
                EnumMappingBuilder builder = new EnumMappingBuilder( mappingContext );
                ...
                MappingMethod enumMappingMethod = builder.build( method );
                ...
                BeanMappingBuilder builder = new BeanMappingBuilder( mappingContext );
                if ( method.getMappings().isEmpty() ) {
                    if ( reverseMappingMethod != null && !reverseMappingMethod.getMappings().isEmpty() ) {
                        method.setMappings( reverse( reverseMappingMethod.getMappings() ) );
                    }
                ...
                BeanMappingMethod beanMappingMethod = builder.getBeanMappingMethod( method );
