...
/**
 * Wraps the assignment in a target setter if CheckHas is set to true.
 *
 * @author Sean Huang
 */
public class HasCheckWrapper extends AssignmentWrapper {

    private final List<Type> thrownTypesToExclude;
    private final String sourceHasMethod;

    public HasCheckWrapper( Assignment decoratedAssignment, List<Type> thrownTypesToExclude,
