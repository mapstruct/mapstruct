...
public @interface Mapper {
     ...
     * cycle between generated mapper classes must be created and given types are not allowed to be
     * used for {@link #usesPlain()}.<br>
     * <p>
     * Instances of the types will be retrieved based on the chosen component model.
     *
    ...
    /**
     * Other mapper types used by this mapper that should not be injected. May be hand-written classes or other
     * mappers generated by MapStruct. No cycle between generated mapper classes must be created and given types are
     * not allowed to be used for {@link #uses()}.<br>
     * <p>
     * Instances of the types will always be retrieved by creating a new instance, therefore an accessible empty
