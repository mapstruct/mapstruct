...
import org.mapstruct.itest.injectionstrategy.field.CustomerFieldMapperTest.SpringTestConfig;
...
public class CustomerFieldMapperTest {
    ...
    @Configuration
    @ComponentScan( basePackageClasses = CustomerFieldMapperTest.class )
