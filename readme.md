...
[![Latest Stable Version](https://img.shields.io/badge/Latest%20Stable%20Version-1.5.0.Final-blue.svg)](http://search.maven.org/#search%7Cga%7C1%7Cg%3Aorg.mapstruct%20AND%20v%3A1.*.Final)
...
dependencies {
    ...
    compile 'org.mapstruct:mapstruct:1.5.0.Final'

    annotationProcessor 'org.mapstruct:mapstruct-processor:1.5.0.Final'
    testAnnotationProcessor 'org.mapstruct:mapstruct-processor:1.5.0.Final' // if you are using mapstruct in test code
}
...
```
